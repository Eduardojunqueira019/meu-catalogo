...
import { CarFront, Users, ShoppingCart, Share2, Edit2, ChevronDown, ArrowRight } from "lucide-react";
...
export default async function DashboardPage() {
  ...
  const clicksWA = publications.length;
  const simulacoes = leads.filter((l: any) => l.status === "simulacao" || l.income || l.downPayment).length;
      ...
      <div className={styles.mainGrid}>
        ...
        <div className={styles.vehiclesContainer}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <h2 className={styles.sectionTitle} style={{ marginBottom: 0 }}>Meus Veículos</h2>
            <Link href="/admin/veiculos" style={{ display: "flex", alignItems: "center", gap: "6px", color: "#3b82f6", fontWeight: "600", fontSize: "14px", textDecoration: "none" }}>
            ...
            <div className={styles.highlightCard}>
              ...
              <div className={styles.highlightInfo}>
                ...
                <div className={styles.actionButtons}>
                  ...
                  <VehicleShareButton vehicle={highlightVehicle} />
                </div>
              </div>
            </div>
          ) : (
              ...
              <div key={v.id} className={styles.smallCard}>
                ...
                <div className={styles.smallInfo}>
                  ...
                  <div className={styles.smallActions}>
                    ...
                    <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`🚘 *${v.name}*\n💰 R$ ${v.price.toLocaleString("pt-BR")}\n👉 Fale comigo agora!\n\n${process.env.NEXT_PUBLIC_BASE_URL || "https://seucatalogo.com"}/veiculo/${v.id}`)}`} 
                       target="_blank" 
                       className={`${styles.btnSolid} ${styles.btnGreen}`} 
                       style={{ padding: "6px 12px", background: "#f0fdf4", border: "1px solid #bbf7d0", color: "#16a34a" }}
                    >
